import DisclosureBoxLanding from "./DisclosureBoxLanding";

function DisclosuresLanding() {
  return (
    <>
      <h3 className="text-3xl text-center text-gray-700 font-semibold mt-10 mb-16">
        FAQ
      </h3>
      <DisclosureBoxLanding title="What is Bindo?">
      ...
      </DisclosureBoxLanding>
      <DisclosureBoxLanding title="How does Bindo work?">
      ...
      <DisclosureBoxLanding title="Is it safe to work with Bindo?">
      ...
      <DisclosureBoxLanding title="What are the risks of staking with Bindo?">
      ...
      <DisclosureBoxLanding title="What is Bindo staking APR for Ethereum?">
      ...
      <DisclosureBoxLanding title="What fee is applied by Bindo? What is this used for?">
      ...
      <DisclosureBoxLanding title="What is stETH?">
      ...
      <DisclosureBoxLanding title="How can I get stETH?">
      ...
      <DisclosureBoxLanding title="How can I use stETH?">
        You can use your stETH as collateral, for lending.
      </DisclosureBoxLanding>
      <DisclosureBoxLanding title="Where can I cover my stETH?">
      ...
      <DisclosureBoxLanding title="How can I unstake stETH?">
...
export default DisclosuresLanding;
